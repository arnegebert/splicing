...
print('Loading data')
cons_exons = np.load('../../data/hipsci_majiq/exon/cons_4.npy')
low_exons = np.load('../../data/hipsci_majiq/exon/low_4.npy')
high_exons = np.load('../../data/hipsci_majiq/exon/high_4.npy')
...
np.save(f'{data_path}/hipsci_majiq/exon/embedded_cons_4.npy', cons_exons)
np.save(f'{data_path}/hipsci_majiq/exon/embedded_low_4.npy', low_exons)
np.save(f'{data_path}/hipsci_majiq/exon/embedded_high_4.npy', high_exons)
