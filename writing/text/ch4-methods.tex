...
%TODO: add process graphics I made
...
\begin{figure}
	\centering\includegraphics[width=0.7\textwidth]{../visualizations/psi_estimation.png} 
	\caption[]{
...
2) Given the information which transcript count as IR or ER from 1) and how frequently each transcript occurs, it estimates the PSI value via $PSI = TPM_{IR} / TPM_{IR} + TPM_{ER}$. SUPPA2 can integrate the TPM values from multiple samples.
...
\begin{figure}
	\centering\includegraphics[width=0.7\textwidth]{../visualizations/splice_graph.png} 
...
\begin{figure}
	\includegraphics[width=0.7\textwidth]{../visualizations/d2v_training.png} 
	\caption{
		% TODO
	}
...
%TODO: add w2v grtaphic from ieee
\begin{figure}
	\includegraphics[width=0.5\textwidth]{../visualizations/tSNE-d2v.png} 	\includegraphics[width=0.5\textwidth]{../visualizations/tSNE-d2v_bases.png} 
	\caption{
		% TODO
		 }
	\label{fig:tsne}
...
\begin{figure}
	\centering\includegraphics[width=0.9\textwidth]{../visualizations/enc_dec.pdf} 
