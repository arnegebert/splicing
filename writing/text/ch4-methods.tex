...
% https://www.biorxiv.org/content/10.1101/095943v1 iPSC-derived sensory neurons
\begin{figure}
...
Even if all of these issues are perfectly handled, the resulting estimate would still not be perfect. For instance, the 'solutions' for 1. and 4. implicitly rely on the assumption that reads across a transcript are evenly distributed. It is well-known that sequence reads across a transcript aren't equally distributed due to duplicate reads, stacking reads or GC-content bias.%TODO[ list of biases duplicate reads, stacking reads]. 
