...
\subsection{Variant and extensions of the attention mechanism} \label{subsec:alternative_attention}
...
We pre-empt the results chapter by noting that we only use the extension of multiple attention heads of the three modifications and extensions of the attentin mechanisms we considered. 
The architecture of our model is visualized in Figure \ref{fig:attnbilstm}. We refer to this new model as Recursive Attentive Splicing Code (RASC). 
\begin{figure}
