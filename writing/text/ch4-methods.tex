...
\begin{itemize}
	...
	\item the first group contains 25 biological replicates (that is, samples from different cell lines developed under the same conditions) of sensory neuron cell lines. These cell lines were obtained by differentiating iPSC cells to sensory neuron cells.
...
The appendix contains detailed information about exactly which samples available from the HipSci portal were chosen \ref{app:hipsci_celllines}.
