...
\begin{figure}
	...
	\caption[test.]{
		The four high-level steps taken to obtain iPSCs \cite{img:ipscprocess}:
...
\begin{itemize}
	...
	\item the second group contains 20 biological replicates of iPSC lines which weren't differentiated to any other cell type. Here care was taken to choose donors from whom at least two different iPSC lines were developed.
