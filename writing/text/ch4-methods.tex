...
%TODO not sure if I explain window correctly
...
Doc2Vec is an extension of Word2Vec which uses the same principles, but can handle variable length texts (such as paragraphs and complete documents) \cite{d2v1} \cite{d2v2}. It returns a fixed-length representation independent of input size.
...
%TODO table with d2v hyperparameters
% TODO explaining the D2V hyperparameters I use and what they mean
\begin{figure}
...
%TODO LSTM opposed to unmodified RNNs are used as they have been shown to be better at retaining information over long sequences and dealing with vanishing and exploding gradient problems. 
