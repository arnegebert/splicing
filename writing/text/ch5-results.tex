...
\begin{enumerate}[label=(\alph*)]
	\item A position, as displayed in \ref{fig:mean_attn}, contains the information from multiple positions in the sequence because RASC is based on BiLSTM units.
