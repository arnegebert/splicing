...
%TODO: one figure, post-poned for fine-tuning as it tilts me
%\begin{figure}
...
%
%\begin{figure}
%	\centering\includegraphics[width=1\textwidth]{../visualizations/ch5-results/mpl_sucks.png} 
%	\caption{Left: ROC curves on dataset based on processing with MAJIQ and iPSC cells differentiated to neurons. Right: ROC curves on dataset based on processing with MAJIQ and undifferentiated iPSC cells. }
%	\label{fig:majiq_rocs}
%\end{figure}
...
We visualize the results in Figure ...
...
%	TODO: https://discourse.matplotlib.org/t/horizontal-and-vertical-lines-between-subplots/13540 or powerpoint, https://stackoverflow.com/questions/26084231/draw-a-separator-or-lines-between-subplots?rq=1
\end{figure}
...
%TODO: sentence about validation vs test loss