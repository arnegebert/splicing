...
%TODO: improve error bar labelling

\begin{figure}
	\centering\includegraphics[width=0.7\textwidth]{../visualizations/ch5-results/gtex_exon_barcharts.png} 
	\caption{Performance on the GTEx-based exon-centric datasets for different tissues. The error bars give the standard deviation across all cross-validation runs. }
...
\begin{enumerate}
	...
	\item We observe overfitting when using this extension. The training curve in Figure \ref{fig:training_curve} %TODO add this and finish this section
...
\subsubsection{Interpreting RASC} \label{subsubsec:attn_interpretation}
...
%TODO attention difference beteween constitutive and non-constitutive samples
