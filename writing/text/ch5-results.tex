...
\begin{figure}
	\centering
	\makebox[0pt]{
		\includegraphics[width=1.2\textwidth]{../visualizations/ch5-results/attention_heatmap.png} 	}
...
To further compare our model to other work, we run an additional 
Taking a departure from our previous methology, 
\begin{table}
	\centering
...
\end{table}
% TODO: say how we do exon classification predominantly / mainly concern ourselves with it
...
%what perfentage are non highly included ones? 
...
%TODO: means I might need to change all the times where I say we do classification
