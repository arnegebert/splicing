...
\begin{enumerate}
	...
	\item We observe increased overfitting when using this extension. The training curve in Figure [...] %TODO add this and finish this section
...
In summary, we only extend RASC with multiple attention heads. The results of RASC we report on the other datasets also use the model with multiple attention heads. 
%include the extension, that is, of 
%
%The architecture of RASC, as selected on the HipSci MAJIQ dataset, was applied While the selection of which extension should be used was based on the HipSci MAJIQ dataset, we applied 
%The convolution extension generally appears to lead to overfitting. 
%Conv: 
