...
%	\includegraphics[width=0.5\textwidth]{../saved/log/GTEx_Junc_Heart_DSC/final/ROC.png} 
	\includegraphics[width=0.85\textwidth]{../saved/log/GTEx_Junc_Heart_Attn/junc_cv_final/ROC.png}
...
%	TODO: only one of these has a title
...
%TODO: observation that best performing datasets contain the most samples
