...
\begin{figure}
	\centering\includegraphics[width=0.7\textwidth]{../visualizations/pre-mrna2mrna.png} 
	\caption[test]
	{The process of splicing visualized. Introns are removed from the pre-mRNA to obtain the mature mRNA. Apart from coding regions, the exons may also consist of non-coding untranslated regions who are also believed to influence gene expression. %[https://commons.wikimedia.org/wiki/File:Pre-mRNA_to_mRNA_MH.svg]
