...
\begin{figure}
	...
	\caption[test]
	{The process of splicing visualized \cite{img:mrna} . Introns are removed from the pre-mRNA to obtain the mature mRNA. Apart from coding regions, the exons may also consist of non-coding untranslated regions who are also believed to influence gene expression. 
