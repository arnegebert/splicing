...
class HIPSCI_MAJIQ_4_EmbeddedDataLoader(BaseDataLoader):
    """
    ...
    def __init__(self, data_dir, batch_size, shuffle=True, validation_split=0.0, num_workers=1, training=True):
        ...
        data_type = 'cass'
        if True:
            x_cons_data = np.load('data/hipsci_majiq/exon/embedded_cons_4.npy')
            hx_cas_data = np.load('data/hipsci_majiq/exon/embedded_high_4.npy')
            lx_cas_data = np.load('data/hipsci_majiq/exon/embedded_low_4.npy')
