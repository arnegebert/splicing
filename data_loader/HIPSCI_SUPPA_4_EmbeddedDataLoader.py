...
class HIPSCI_SUPPA_4_EmbeddedDataLoader(BaseDataLoader):
    """
    ...
    def __init__(self, data_dir, batch_size, shuffle=True, validation_split=0.0, num_workers=1, training=True):
        ...
        data_type = 'cass'
        if True:
            x_cons_data = np.load('data/hipsci_suppa/4_embedded_cons.npy')
            hx_cas_data = np.load('data/hipsci_suppa/4_embedded_high.npy')
            lx_cas_data = np.load('data/hipsci_suppa/4_embedded_low.npy')
